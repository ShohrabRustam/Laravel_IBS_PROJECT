...
@section('section')
    <a href="{{ url('lifeInsurance') }}">
        <div class="feature-container">
            ...
            <p> Death is a reality for everyone. You want to make sure that your family is protected after your
                ...
                insurance gives you peace of mind that your spouse and your children are financially stable after your
                passing.
            </p>
        </div>
    </a>

    <a href="{{ url('healthInsurance') }}">
        <div class="feature-container">
    ...
    <a href="{{ url('bikeInsurance') }}">
        <div class="feature-container">
            ...
            <p>It helps you stay stress-free - In case you are not a confident driver, getting your car adequately insured
                will
                help in reducing the stress of driving. Even for experienced drivers, car insurance is a necessity as they
                may
    ...
    <a href="{{ url('carInsurance') }}">

        <div class="feature-container">
            <img src="https://www.icicilombard.com/docs/default-source/assets/freshlook/images/car-keys.png"
                alt="Flexbox Feature" style="max-height: 280px">
            <h2>Car Insurance </h2>
            <p>If your car is involved in an accident that results in damage or loss to the property of any third parties,
                it is
                covered under the car insurance. Furthermore, if you face any legal liabilities in case of any bodily injury
                or
