<nav class="navbar">
    ...
    <ul class="nav no-search">
        @if (Session::has('user'))
            ...
            <li class="nav-item"><a href="{{ url('/users') }}" style="margin-left:10px ">Users</a></li>
            <li class="nav-item"><a href="{{ url('/admins') }}" style="margin-left:10px ">Admins</a></li>            <li class="nav-item"><a href="{{ url('/superAdminLogout') }}" style="margin-left:10px "> Logout</a></li>
    @else
